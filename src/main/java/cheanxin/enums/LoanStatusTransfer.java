...
public enum LoanStatusTransfer {
    ...
    SECOND_REVIEW_PENDING_TO_LOAN_ABORTED(7, LoanStatus.SECOND_REVIEW_PENDING, LoanStatus.LOAN_ABORTED, new SimpleGrantedAuthority(Authority.ROLE_SECOND_REVIEW_PENDING_TO_SECOND_REVIEW_REJECTED.name())),
    SECOND_REVIEW_ACCEPTED_TO_CONTRACT_ACCEPTED(8, LoanStatus.SECOND_REVIEW_ACCEPTED, LoanStatus.CONTRACT_ACCEPTED, new SimpleGrantedAuthority(Authority.ROLE_SECOND_REVIEW_ACCEPTED_TO_CONTRACT_ACCEPTED.name())),
    SECOND_REVIEW_ACCEPTED_TO_CONTRACT_REJECTED(9, LoanStatus.SECOND_REVIEW_ACCEPTED, LoanStatus.CONTRACT_REJECTED, new SimpleGrantedAuthority(Authority.ROLE_SECOND_REVIEW_ACCEPTED_TO_CONTRACT_REJECTED.name())),
    CONTRACT_REJECTED_TO_SECOND_REVIEW_PENDING(10, LoanStatus.CONTRACT_REJECTED, LoanStatus.SECOND_REVIEW_PENDING, new SimpleGrantedAuthority(Authority.ROLE_CONTRACT_REJECTED_TO_SECOND_REVIEW_PENDING.name())),
    CONTRACT_REJECTED_TO_LOAN_ABORTED(11, LoanStatus.CONTRACT_REJECTED, LoanStatus.LOAN_ABORTED, new SimpleGrantedAuthority(Authority.ROLE_CONTRACT_REJECTED_TO_LOAN_ABORTED.name())),
    SECOND_REVIEW_ACCEPTED_TO_LOAN_ABORTED(12, LoanStatus.SECOND_REVIEW_ACCEPTED, LoanStatus.LOAN_ABORTED, new SimpleGrantedAuthority(Authority.ROLE_SECOND_REVIEW_ACCEPTED_TO_CONTRACT_REJECTED.name()));
